...
class DriftAnalyzer:
    ...
    def _load_data(self, source: str, fetcher: DataStorage) -> pl.DataFrame:
    ...
    def analyze(self, reference_source: str, current_source: str, fetcher: DataStorage) -> pl.DataFrame:
        """
